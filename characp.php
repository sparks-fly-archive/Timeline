...
$lang->load('timeline');
$user_lang = $lang->sprintf($lang->timeline_description_desc, $uid);
...
if($mybb->input['action'] == "timeline") {
    ...
    eval("\$page = \"".$templates->get("characp_timeline")."\";");
    output_page($page);
}
...
if($mybb->input['action'] == "do_timeline") {
	...
	redirect("index.php", "Die Beschreibung wurde hinzugefügt!");
